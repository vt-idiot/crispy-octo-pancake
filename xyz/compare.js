...
var filenames = [
	['Latent', '01-Latent.png'],
	['Latent (antialiased)', '02-Latent_antialiased.png'],
	['Latent (bicubic)', '03-Latent_bicubic.png'],
	['Latent (bicubic antialiased)', '04-Latent_bicubic_antialiased.png'],
	['Latent (nearest)', '05-Latent_nearest.png'],
	['Latent (nearest-exact)', '06-Latent_nearest-exact.png'],
	['None', '07-None.png'],
	['Lanczos', '08-Lanczos.png'],
	['Nearest', '09-Nearest.png'],
	['4x-AnimeSharp', '10-4x-AnimeSharp.png'],
	['4x-UltraMix (Balanced)', '11-4x-UltraMix_Balanced.png'],
	['4x-UltraMix (Smooth)', '12-4x-UltraMix_Smooth.png'],
	['lollypop', '13-lollypop.png'],
	['R-ESRGAN 4x+', '14-R-ESRGAN_4x.png'],
	['R-ESRGAN 4x+ Anime6B', '15-R-ESRGAN_4x_Anime6B.png'],
	['LDSR', '16-LDSR.png'],
	['ScuNET GAN', '17-ScuNET_GAN.png'],
	['ScuNET PSNR', '18-ScuNET_PSNR.png'],
	['SwinIR 4x', '19-SwinIR_4x.png']
]
...
function drag(dragHandle, resizeElement, container) {
	...
	function startSliding(e) {
		...
		maxRight = containerOffset + containerWidth;
